...
let fruits = ["Maçã", "Banana", "Laranja", "Uva", "Morango"]
...
let cars = ["Chevette", "Opala", "Caravan", "Omega", "Apollo"]
...
let numeros = [2, 3, 4, 5, 6, 7, 8, 11]
console.log(somaPrimos(numeros))
...
function saudacao() {
    ...
    let idade = ask.questionInt("Digite sua idade: ")
